...
#include <string>
#include "Rectangle.h"
#include "/home/student/cplusplus-fvtc/1stCBApp/1stCBApp/HelperBot.h"
...
int main()
{
    ...
    Rectangle my_rectangle = Rectangle(length, width);

    //display the area and perimeter to the user
    cout << endl << "Area = " << my_rectangle.get_area() << endl;
    cout << "Perimeter = " << my_rectangle.get_perimeter() << endl << endl;

    cout << my_rectangle.to_string();
